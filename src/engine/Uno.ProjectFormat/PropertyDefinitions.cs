...
namespace Uno.ProjectFormat
{
    public class PropertyDefinitions : Dictionary<string, Tuple<PropertyType, string>>
    {
        public static readonly PropertyDefinitions Items = new PropertyDefinitions
        {
            ...
            {"Version", PropertyType.String, "0.0.0"},
            {"VersionCode", PropertyType.Integer, 0},
            ...
            {"iOS.Icons.iPhone_29_1x", PropertyType.Path, "$(Icon)"},
            ...
            {"iOS.Icons.iPhone_57_1x", PropertyType.Path, "$(Icon)"},
            {"iOS.Icons.iPhone_57_2x", PropertyType.Path, "$(Icon)"},
            ...
            {"iOS.Icons.iPad_50_1x", PropertyType.Path, "$(Icon)"},
            {"iOS.Icons.iPad_50_2x", PropertyType.Path, "$(Icon)"},
            {"iOS.Icons.iPad_72_1x", PropertyType.Path, "$(Icon)"},
            {"iOS.Icons.iPad_72_2x", PropertyType.Path, "$(Icon)"},
            ...
            {"HTML.Title", PropertyType.String, "$(Title)"},
            {"HTML.Favicon", PropertyType.Path, "$(Icon)"},
